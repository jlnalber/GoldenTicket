...
function getKarten() {
    ...
    return karten !== null && karten !== void 0 ? karten : [];
}
...
function maleKartenInContentDiv(contentDiv, selector) {
...
function maleNeueSeite() {
    ...
    inp.onchange = () => {
        var _a;
        if (inp.files) {
            const file = (_a = inp.files) === null || _a === void 0 ? void 0 : _a.item(0);
            file === null || file === void 0 ? void 0 : file.text().then(t => {
                try {
                    ks = JSON.parse(t);
...
function maleNeueKartenInContentDiv(contentDiv, karten) {
    contentDiv.innerHTML = '';
    const centerWrapperDiv = document.createElement('div');
    contentDiv.appendChild(centerWrapperDiv);
    centerWrapperDiv.classList.add('centerContent');
